...
class Init extends FlxState
{
	...
	public static var gameSettings:Map<String, Dynamic> = [
		...
		'BG Color' => [
			'Green',
			Selector,
			'Change the color of the bg and font. (reloading may be required)',
			NOT_FORCED,
		...
		'Classic Health Bar' => [
			false,
			Checkmark,
			"If you like the classic green and red healthbar, thats your luck day.",
			NOT_FORCED
		],
		'Show Canon text' => [
			true,
			Checkmark,
			"If checked, will be show if the song is canon or a incident.",
			NOT_FORCED
		],
		'Stage Opacity' => [
			Checkmark,
		...
		'Hitsounds' => [
			false,
			Checkmark,
			'If enabled, notes will make \"tick\" sounds if they are hit.',
			NOT_FORCED
		],
		'Late Damage' => [
			true,
			Checkmark,
			'If enabled, getting a shit will hurt you instead of healing you.',
			NOT_FORCED
		],
		'Anti Mash' => [
			true,
		...
		'Healthbar Overlay' => [
			true,
			Checkmark,
			'The healthbar overlay.',
			NOT_FORCED
		],
		'Overlay' => [
			true,
			Checkmark,
			'That grid that being in up.',
			NOT_FORCED
		],
		// MODES
