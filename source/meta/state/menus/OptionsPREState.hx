...
class OptionsPREState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		Application.current.window.title = "Friday Night Funkin': V.S Hankus 2023 Remake - Pre-Options menu";
		...
		infoText.setFormat("Futura Extra Black BT", 20, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
