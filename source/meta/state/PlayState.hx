...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var Overlay:FlxSprite = new FlxSprite(0).loadGraphic(Paths.image('UI/Overlay'));
	...
	public function reloadCharacterIcons() {
		...
		if (Init.trueSettings.get('Downscroll'))
			ObarY = 64;
		var healthBarOverlay:FlxSprite = new FlxSprite(0, ObarY).loadGraphic(Paths.image('UI/healthBarOverlay'));
